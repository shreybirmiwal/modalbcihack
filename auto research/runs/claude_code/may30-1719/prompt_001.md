...
- Current best reward before this iteration: 1.406824

Experiment command:
```bash
uv run python train.py --subject S03 --stage 4 --sealed --export-final --data-glob ../bci-sdk/data/*_prod*.csv --data-glob ../bci-sdk/data/*_prod*.csv > run.log 2>&1
```
...
change. It logs to `/Users/shreybirmiwal/projects/modalhack/auto research/runs/claude_code/may30-1719/results.tsv`.
